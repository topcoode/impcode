...
func HTTPPoliciesPolAssoIdDelete(c *gin.Context) {
	...
	if err != nil {
		logger.AMpolicylog.Errorln("HTTPPoliciesPolAssoIdDelete serialization Error occured ", err)
...
func HTTPPoliciesPolAssoIdGet(c *gin.Context) {
	...
	responseBody, err := openapi.Serialize(rsp.Body, "application/json")
	if err != nil {
		logger.AMpolicylog.Errorln("HTTPPoliciesPolAssoIdGet serialization Error occured", err)
		problemDetails := models.ProblemDetails{
			Status: http.StatusInternalServerError,
			Cause:  "SYSTEM_FAILURE",
			Detail: err.Error(),
...
func HTTPPoliciesPolAssoIdUpdatePost(c *gin.Context) {
	...
	if err != nil {
		...
		logger.AMpolicylog.Errorf("HTTPPoliciesPolAssoIdUpdatePost Get Request Body error In getting RawData: %+v", err)
	...
	if err != nil {
		...
		logger.AMpolicylog.Errorln("HTTPPoliciesPolAssoIdUpdatePost Deserialize Error ", problemDetail)
	...
	responseBody, err := openapi.Serialize(rsp.Body, "application/json")
	if err != nil {
		logger.AMpolicylog.Errorln("HTTPPoliciesPolAssoIdUpdatePost serialize Error ", err, "with policyID=", req.Params["polAssoId"])
		problemDetails := models.ProblemDetails{
			Status: http.StatusInternalServerError,
			Cause:  "SYSTEM_FAILURE",
			Detail: err.Error(),
